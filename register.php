...
<body>
    <div class="login-container">
        <div class="login-image">
            <img src="images/sea.jpg" alt="Background image">
        </div>
        <div class="login-form">
            ...
            <form action="register_script.php" method="post">
                ...
                <button type="submit" style="width:500px">Register</button>

            </form>
            <p style="text-align: center; margin-top: 20px;">Already has an
                account !!<a href="login.php">Sign In</a></p>
        </div>
    </div>
</body>
